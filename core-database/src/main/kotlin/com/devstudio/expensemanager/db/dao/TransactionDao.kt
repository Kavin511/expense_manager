...
order by transactionDate DESC"""
    ...
    suspend fun getTransactionById(
        id: Long, shouldUseBookId: Boolean = false,
        bookId: Long = 0
    ): Transaction?
    ...
    fun filterTransactionDateRange(
        startDate: Long, endDate: Long, shouldUseBookId: Boolean = false,
        bookId: Long = 0
    ): Flow<List<Transaction>>
    ...
    fun getCurrentMonthTransaction(
        month: String, year: String, shouldUseBookId: Boolean = false,
        bookId: Long = 0
    ): Flow<List<Transaction>>
    ...
    fun getTransactionCategoryName(
        categoryId: String, shouldUseBookId: Boolean = false,
        bookId: Long = 0
    ): String?
    ...
    fun getTotalAssets(
        mode: String, shouldUseBookId: Boolean = true,
        bookId: Long = 0
    ): Double
}